...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Lower| Ctrl | Alt  | GUI  |  App |  `~  |Space |Space |  [{  |  ]}  |  /?  | Left | Down |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      LOWER,   KC_LCTL, KC_LALT, KC_LGUI, KC_APP,  KC_GRV,  KC_SPC,  KC_SPC,  KC_LBRC, KC_RBRC, KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT  \
      ),
